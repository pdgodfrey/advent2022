...
pairs.each{|pair|
  ...
  if first_min.between?(second_min, second_max) || first_max.between?(second_min, second_max) ||
     second_min.between?(first_min, first_max) || second_max.between?(first_min, first_max)
    score +=1
  end
